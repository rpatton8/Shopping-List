...
class Status {
    ...
    Status(String itemName, String status, String checked, Context context) {
        ...
        if (status.equals(this.context.getString(R.string.instock))) {
            isInStock = true;
            isNeeded = false;
            isPaused = false;
        } else if (status.equals(this.context.getString(R.string.needed))) {
            isInStock = false;
            isNeeded = true;
            isPaused = false;
        } else if (status.equals(this.context.getString(R.string.paused))) {
            isInStock = false;
            isNeeded = false;
            isPaused = true;
        }
