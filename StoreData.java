...
public class StoreData {
    ...
    public Map<String, Integer> getItemsNeededMap() {
        return itemsNeededMap;
    }
    ...
    public void readStore(String storeName, int numItemsNeeded) {
        ...
        itemsNeededMap.put(storeName, numItemsNeeded);
    }
